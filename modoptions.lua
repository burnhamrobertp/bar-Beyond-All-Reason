		...
		items = {
			{
				...
				unlock = { "sub_header_lava1", "sub_header_lava2" },
			},
			{
				key = "enabled",
				...
				lock = { "sub_header_lava1", "sub_header_lava2" },
			},
			{
				key = "disabled",
				name = "Disable",
		...
		items = {
			{
				key = "enabled",
				name = "Enabled",
				unlock = { "assistdronesbuildpowermultiplier", "assistdronescount", "assistdronesair" },
			},
			{
				key = "disabled",
				name = "Disabled",
				lock = { "assistdronesbuildpowermultiplier", "assistdronescount", "assistdronesair" },
			},
		},
	},
